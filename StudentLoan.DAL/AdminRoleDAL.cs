...
namespace StudentLoan.DAL
{
    ...
    public class AdminRoleDAL : BaseDAL
    {
        ...
        public bool Exists(string roleName)
        {
            ...
            commandText.Append("Select roleName From sl_admin_role Where RoleName = @RoleName");
            ...
            paramsList.Add(new SqlParameter("@RoleName", roleName));
        ...
        public int Insert(AdminRoleEntityEx model)
        {
            ...
            commandText.Append(" @RoleName,@RoleType,@IsSystem);Select @@Identity; ");
