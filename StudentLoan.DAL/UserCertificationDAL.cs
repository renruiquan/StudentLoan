...
namespace StudentLoan.DAL
{
    ...
    public class UserCertificationDAL : BaseDAL
    {
        ...
        public bool Insert(UserCertificationEntityEx model)
        {
            ...
            commandText.Append(" UserId,Type,CertificationName,Images,Point,Count,Status,Remark,CreateTime) ");
        ...
        public bool Update(UserCertificationEntityEx model)
        {
            ...
            commandText.Append(" CertificationName = @CertificationName, ");
            
            commandText.Append(" Images = @Images, ");
            
            commandText.Append(" Point = @Point, ");
            
            commandText.Append(" Count = @Count, ");
        ...
        /// 获取一个实体
        /// </summary>
        public UserCertificationEntityEx GetModel(int Id)
        {
            #region CommandText
            
            StringBuilder commandText = new StringBuilder();

            commandText.Append(" Select Top 1 Id,UserId,Type,CertificationName,Images,Point,Count,Status,Remark,CreateTime From sl_user_certification Where Id = @Id ");
