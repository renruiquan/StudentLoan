...
namespace StudentLoan.DAL
{
    ...
    public class UserMessageDAL : BaseDAL
    {
        ...
        public bool Insert(UserMessageEntityEx model)
        {
            ...
            commandText.Append(" Type,PostUserName,AcceptUserName,IsRead,Title,Content,CreateTime,ReadTime) ");
            ...
            paramsList.Add(new SqlParameter("@IsRead", model.IsRead));
            ...
            paramsList.Add(new SqlParameter("@ReadTime", model.ReadTime));
        ...
        public bool Update(UserMessageEntityEx model)
        {
            ...
            commandText.Append(" PostUserName = @PostUserName, ");
            
            commandText.Append(" AcceptUserName = @AcceptUserName, ");
            
            commandText.Append(" IsRead = @IsRead, ");
            
            commandText.Append(" Title = @Title, ");
            
            commandText.Append(" Content = @Content, ");
            
            commandText.Append(" CreateTime = @CreateTime, ");
            
            commandText.Append(" ReadTime = @ReadTime ");
