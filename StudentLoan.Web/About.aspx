        ...
        <div class="wrapper">
            <div class="menu">
                <div class="item">
                    <h2>关于我们</h2>
                    <ul>
                        <li><a class="active" href="javascript:;"><i class="ico-note"></i>安全保障</a></li>
                    ...
                    <div class="article">
                        ...
                        <div class="media">
                            <a class="pull-left" href="#">
                                <img class="media-object" src="../css/img/admin/safety_2.jpg" width="180" height="180" />
                            </a>
                        ...
                        <div class="media">
                            <a class="pull-left" href="#">
                                <img class="media-object" src="../css/img/admin/safety_3.jpg" width="180" height="180" />
                            </a>
                        ...
                        <div class="media">
                            <a class="pull-left" href="#">
                                <img class="media-object" src="../css/img/admin/safety_4.jpg" width="180" height="180" />
                            </a>
