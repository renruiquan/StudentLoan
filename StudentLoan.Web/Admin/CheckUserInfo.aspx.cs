...
namespace StudentLoan.Web.Admin
{
    public partial class CheckUserInfo : AdminBasePage
    {
        ...
        protected void btnPass_ServerClick(object sender, EventArgs e)
        {
            ...
            StudentLoan.API.Message.Send(new UsersBLL().GetModel(userLoanModel.UserId).Mobile, "【学子易贷】已将您所申领的U豆送达至您的小金库，请登录网站查收，多谢关注【学子易贷】http://www.utllcenter.com");
        ...
        protected void btnRefuse_ServerClick(object sender, EventArgs e)
        {
            ...
            StudentLoan.API.Message.Send(new UsersBLL().GetModel(userLoanModel.UserId).Mobile, "【学子易贷】您所申请的“点豆成金”业务因资料不全而未通过审核，具体请登录网站个人中心查看。");
