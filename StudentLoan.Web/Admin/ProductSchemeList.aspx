<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductSchemeList.aspx.cs" Inherits="StudentLoan.Web.Admin.ProductSchemeList" %>
...
<body>
    <form id="form1" runat="server" class="form-inline">
        <div class="container">
            <div class="location">当前位置：理财管理 -&gt; 方案列表</div>
            ...
            <div class="block">
                <div class="h">
                    ...
                    <h3>理财方案列表</h3>
                    <div class="bar">
                        <a class="btn-lit" href="ProductSchemeAdd.aspx"><span>新增</span></a>
                    </div>
                </div>
                <div class="tl corner"></div>
                <div class="tr corner"></div>
