            ...
            <div class="form-horizontal">
                ...
                <div class="item">
                    ...
                    <div id="divOldPassword" runat="server" class="control-group">
                        ...
                        <div class="controls">
                            <asp:TextBox ID="txtOldPassword" ClientIDMode="Static" CssClass="span5" runat="server" TextMode="Password" datatype="*" />
                        </div>
                    </div>
