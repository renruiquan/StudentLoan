...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tabs">
        ...
        <ul>
            <li class="active"><a href="javascript:;">账户认证</a></li>
        </ul>
        ...
        <div class="item">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><p>个人详细信息（10分）</p></td>
                    <td><p>已完成</p></td>
                    <td rowspan="3"><p><span class="big-num">30</span>分</p></td>
                </tr>
                <tr>
                    <td><p>学校信息（10分）</p></td>
                    <td><p><a href="javascript:;">未完成</a></p></td>
                </tr>
                <tr>
                    <td><p>家属与同学信息（10分）</p></td>
                    <td><p><a href="javascript:;">未完成</a></p></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><p>身份证认证（15分）</p></td>
                    <td><p><a href="javascript:;">未完成</a></p></td>
                    <td rowspan="2"><p><span class="big-num">0</span>分</p></td>
                </tr>
                <tr>
                    <td><p>学生证认证（15分）</p></td>
                    <td><p><a href="javascript:;">未完成</a></p></td>
                ...
                <tr>
                    <td><p>银行卡流水认证（1分）</p></td>
                    <td><p><a href="javascript:;">未完成</a></p></td>
                </tr>
                <tr>
                    <td><p>支付宝流水帐单（1分）</p></td>
                    <td><p><a href="javascript:;">未完成</a></p></td>
                </tr>

                <tr>
                    <td><p>手机通话记录清单（1分）</p></td>
                    <td><p><a href="javascript:;">未完成</a></p></td>
                </tr>
                <tr>
                    <td><p>家长身份认证（2分）</p></td>
                ...
                <tr>
                    ...
                    <td><p>还清笔数（+1分/笔，加分间隔一天）</p></td>
                    <td><p><a href="javascript:;">未完成</a></p></td>
                </tr>
                <tr>
                    <td><p>逾期5天以上扣一分</p></td>
                    <td><p><a href="javascript:;">未完成</a></p></td>
                    <td><p><span class="big-num">0</span>分</p></td>
                </tr>
                <tr>
                    <td><p>逾期5天以上逾期费用100/月</p></td>
                    <td><p><a href="javascript:;">未完成</a></p></td>
                    <td><p><span class="big-num">0</span>分</p></td>
                </tr>
                </tbody>
