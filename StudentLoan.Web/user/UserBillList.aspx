<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserMain.Master" AutoEventWireup="true" CodeBehind="UserBillList.aspx.cs" Inherits="StudentLoan.Web.user.UserBillList" %>
        ...
        <div class="cont">
            ...
            <div class="tabbable">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="UserBillList.aspx" data-toggle="tab">已出账单</a></li>
                    <li><a href="UserBillList_2.aspx" data-toggle="tab">未出账单</a></li>
                </ul>
