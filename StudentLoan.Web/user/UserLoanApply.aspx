                ...
                <div class="form-horizontal">
                    ...
                    <div class="item">
                        <div class="control-group">
                            <label class="control-label" for="txtLoanTitle"><span class="c-red">*</span> 借款标题：</label>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="ddlTotalAmortization"><span class="c-red">*</span> 借款期限：</label>
                        ...
                        <div class="control-group">
                            <label class="control-label"><span class="c-red">*</span> 成交服务费：</label>

                            <div class="controls text-left">
                                <p class="mt5 c-blue">只要申请贷款成功，所有信用等级的服务费都为9%/月，但信用等级越高贷款的成功性越大。</p>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls text-left">
                                ...
                                <asp:TextBox type="text" CssClass="w600" ID="txtLoanDescription" placeholder="借款描述,最多500个汉字" TextMode="MultiLine" Rows="10" runat="server" />
